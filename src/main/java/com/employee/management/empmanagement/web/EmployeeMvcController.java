...
public class EmployeeMvcController {
    ...
    @Value("${spring.data.endpoint.url}")
    String connectionURL;

    @RequestMapping
    public String getAllEmployees(Model model) {
        List<EmployeeEntity> list = (List<EmployeeEntity>) restTemplate.getForObject(connectionURL + "/data", List.class);
    ...
    public String editEmployeeById(Model model, @PathVariable("id") Optional<Long> id)
        ...
        if (id.isPresent()) {
            ...
            ResponseEntity<EmployeeEntity> entity = restTemplate.getForEntity(connectionURL + "/data/edit/" + id.get(), EmployeeEntity.class);
    ...
    public String deleteEmployeeById(Model model, @PathVariable("id") Long id)
        ...
        ResponseEntity<String> resEntity = restTemplate.exchange(connectionURL + "/data/delete/" + id, HttpMethod.DELETE, reqEntity, String.class);
    ...
    public String createOrUpdateEmployee(EmployeeEntity employee) {
        ...
        //ResponseEntity<String> resEntity = restTemplate.exchange(connectionURL+"/data/create-update", HttpMethod.POST, reqEntity, String.class);


        ResponseEntity<String> resEntity = restTemplate.postForEntity(
                connectionURL + "/data/create-update", reqEntity, String.class);
